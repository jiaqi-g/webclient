...
public class JdbcClient {
	...
	static {
		try {
			...
			Connection con = DriverManager.getConnection("jdbc:hive://localhost:" + Conf.getPort() + "/default", "" , "");
